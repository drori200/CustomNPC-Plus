...
public class ItemPlayerWand extends Item {

    public ItemPlayerWand(){
        maxStackSize = 1;
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer){
        ...
        CustomNpcs.proxy.openGui(0, 0, 0, EnumGuiType.PlayerMainMenuDisplay, par3EntityPlayer);
        return par1ItemStack;
    }
